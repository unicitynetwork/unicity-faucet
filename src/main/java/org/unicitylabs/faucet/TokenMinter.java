...
public class TokenMinter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TokenMinter.class);
    ...
    public TokenMinter(String aggregatorUrl, byte[] privateKey, String apiKey) throws Exception {
        ...
        try {
            ...
            logger.debug("Loaded RootTrustBase from trustbase-testnet.json");
        } catch (Exception e) {
    ...
    public CompletableFuture<Token<MintTransactionReason>> mintToken(
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                logger.trace("Minting token: tokenType={} coinId={} amount={}", tokenTypeHex, coinIdHex, amount);
                ...
                logger.trace("Mint: submitting commitment to aggregator");
                ...
                logger.trace("Mint: commitment submitted, waiting for inclusion proof");
                ...
                logger.trace("Mint: inclusion proof received");
                ...
                logger.trace("Mint: token minted id={}", Hex.encodeHexString(tokenIdData));
                return token;
            } catch (Exception e) {
    ...
    public CompletableFuture<TransferInfo> transferToProxyAddress(
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                logger.trace("Transfer: to proxy={}", recipientProxyAddress.getAddress());
                ...
                logger.trace("Transfer: submitting commitment to aggregator");
                ...
                logger.trace("Transfer: commitment submitted, waiting for inclusion proof");
